...
$page['desc'] = 'وصف محتوى الصفحة ';
 ...
 include('templeat_header.php');
  ...
  <div class="col-md-12  ">
                         ...
                         <h5 align="right" > معلومات العطاء  </h5>  
                         <hr />
  ...
  <tr>
    <td>رقم العطاء : <?php echo $row_tender_info['tender_number']; ?></td>
   
    <td>تاريخ بدء التسليم : <?php echo $row_tender_info['tender_start_submission']; ?></td>
   
    <td>تاريخ انتهاء التسليم : <?php echo $row_tender_info['tender_end_submission']; ?></td>
  
    <td>تاريخ فتح العطاء : <?php echo $row_tender_info['tender_open_date']; ?></td>
  </tr>
 
  <tr>
    <td>سعر العطاء : <?php echo $row_tender_info['tender_price']; ?></td>
  
    <td>صفري : <?php echo $row_tender_info['tender_vat']; ?></td>
 
    <td>تكاليف الاعلان في الجريدة : <?php echo $row_tender_info['adv_cost']; ?></td>
  
    <td>الكفاله : <?php echo $row_tender_info['Warranty']; ?></td>
  </tr>
  <tr>
    <td>فترة التنفيذ : <?php echo $row_tender_info['Implementation_period']; ?></td>
   
    <td>الخطوط المرجعية  : <a class="btn btn-primary text-white" data-toggle="modal" data-target=".TOR" >View TOR</a></td>
  
    <td>تاريخ اضافة العطاء : <?php echo $row_tender_info['insert_date']; ?></td>
