...
mysql_select_db($database_conn, $conn);
$query_activ_cources = "SELECT courses.c_id, courses.c_name, courses.c_hours, users.user_name, courses.c_status, courses.insert_date, courses.c_cost  FROM courses, users WHERE courses.c_type=3 AND courses.c_teatcher = users.user_id ORDER BY courses.c_status DESC , courses.insert_date DESC";
...
$page['desc'] = 'وصف محتوى الصفحة ';
 ...
 include('templeat_header.php');
  ?>
<h3 align="center" >دورات التاسيس </h3> 
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header" align="center">
        ...
        <h4 class="modal-title" align="center">  فتح دورة تاسيس جديدة   </h4>
      </div>
...
?>
            ...
            <tr valign="baseline">
              ...
              <td><input type="submit" value="  فتح شعبة   تاسيس " /></td>
            </tr>
          </table>
