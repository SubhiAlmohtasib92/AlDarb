...
mysql_select_db($database_conn, $conn);
$query_students_father = "SELECT * FROM users WHERE user_type = 3";
...
$page['desc'] = 'وصف محتوى الصفحة ';
 ...
 include('templeat_header.php');
  ?>
<h3 align="center" > اولياء الامور      </h3> 
...
<h6 class="p-2 element-header" align="right" >  الرجاء تحديد ولي امر الطالب لاضافة الطالب  </h6>
    ...
    <?php do { ?>
      <tr>
        ...
        <td><?php echo $row_students_father['mobile']; ?></td>
            <td>  <a class="btn btn-dark" href="admin_father_profile.php?id=<?php echo $row_students_father['user_id']; ?>" > فتح الملف    </a>   </td>
      </tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">  اضافة ولي امر جديد </h4>
      </div>
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1" dir="rtl" >
          <table class="table" align="center">
            ...
            <tr valign="baseline">
              ...
              <td><input type="submit" value="  اضافة ولي امر " /></td>
            </tr>
          </table>
